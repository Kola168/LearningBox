// pages/package_feature/print_name/preview.js
const app = getApp()
...
Page({
  ...
  onLoad: co.wrap(function*(query) {
    this.sn = query.sn
    this.type=query.type||'name_sticker'
  ...
  onShareAppMessage: function(res) {
    ...
    if (res.from === 'button' || res[0].from === 'button') {
      return {
        title: "这是我的姓名贴，你也想要体验吗？",
        path: `/pages/package_feature/print_name/preview?share_user_id=${this.user_id}&sn=${this.sn}`
      }
    } else {
      return app.share
    }
