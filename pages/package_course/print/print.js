...
Page({
  ...
  zoomImg(e) {
    let index = Number(e.currentTarget.id),
      url = this.data.lessonImgs[index].url + '?x-image-process=image/resize,p_50/watermark,image_L21pY3JvL0xldmlhdGhhbi9iYWNrZW5kL3dhdGVybWFya2VyLnBuZw==,g_center,t_50/resize,w_700'
    wx.previewImage({
      urls: [url]
    })
  },
