...
Page({
  ...
  zoomImg(e) {
    let index = Number(e.currentTarget.id),
      url = this.data.lessonImgs[index].url + '?x-image-process=image/resize,w_1240,limit_0/watermark,image_L21pY3JvL0xldmlhdGhhbi9iYWNrZW5kL3dhdGVybWFya2VyLnBuZw==,g_center,t_50/resize,w_700'
    wx.previewImage({
      urls: [url]
    })
  },
