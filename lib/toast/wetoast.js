...
function weToastClass(ctx) {
  //构造函数
  function weToast(ctx) {
    var curPage
    /**
     * @param {Object} context 
     * @return {Object} 
     */
    let pageThis = function (context) {
       if (!context) {
      ...
      if (typeof context != 'object') {
        throw('weToastClass content must be Object')
      }
      curPage = context
      return context
    }
    this.__page = pageThis(ctx)
    this.__timeout = null
